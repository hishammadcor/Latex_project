...
| Left aligned     | R      | Left-aligned column with flexible width, green background  | 7            | Normal Numbers with no decimal places rounded to the nearest 100 (integers) |
| Left aligned     | S      | Left-aligned column with flexible width                    |              |                                                                             |
| Centered aligned | T      | Centered column with flexible width, green background      |              |                                                                             |
| Centered aligned | U      | Centered column with flexible width                        |              |                                                                             |
| Right aligned    | V      | Right-aligned column with flexible width, green background |              |                                                                             |
| Right aligned    | W      | Right-aligned column with flexible width                   |              |                                                                             |
